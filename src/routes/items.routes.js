...
const { listItems, createItems } = require("../controllers/items.controllers.js"); //importa a function do controller
...
router.post("/", createItems); //quando chegar POST dessa raiz --> chama createItems
