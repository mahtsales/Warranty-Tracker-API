Warranty Tracker API / API de Controle de Garantias

API backend desenvolvida para gerenciar itens com garantia, permitindo registrar produtos, acompanhar datas de compra e controlar vencimento de garantias.

Backend API developed to manage warranty items, allowing users to register products, track purchase dates and monitor warranty expiration.
...
The project also follows a structured architecture separating routes, controllers and database connection.
